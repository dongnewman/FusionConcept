...
body["rows"] = [Dict("candidate_result_hash" => item["result_hash"],
    "repair_declaration" => item["repair_declaration"],
...
println(JSON3.write(Dict("status" => body["status"],
    "repair_proposal_count" => body["repair_proposal_count"],
    "repair_prefilter_survivor_count" => body["repair_prefilter_survivor_count"],
    "repair_prefilter_reject_count" => body["repair_prefilter_reject_count"],
